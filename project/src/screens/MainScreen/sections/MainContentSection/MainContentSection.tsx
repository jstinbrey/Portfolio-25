  ...
  return (
    <div className="w-full relative">
      <div className="h-[1200px] relative w-full max-w-[1104px] mx-auto px-12">
        ...
        <div className="absolute w-full max-w-[1104px] h-20 top-[701px] left-0">
          <div className="relative w-[492px] h-[97px] top-[-9px] left-[-5px]">
            ...
            <Button className="absolute w-[152px] h-[66px] top-4 left-[334px] bg-zinc-950 rounded-2xl border border-solid border-[#232b34] rotate-[12.36deg] shadow-[9.6px_9.6px_0px_#232b34,7.2px_7.2px_0px_#232b34,4.8px_4.8px_0px_#232b34,2.4px_2.4px_0px_#232b34] h-auto">
              <div className="absolute w-[105px] h-[13px] top-6 left-6 [font-family:'Consolas-Regular',Helvetica] font-normal text-white text-[13.3px] text-center tracking-[0.76px] leading-[20.0px] whitespace-nowrap">
                EXPLORE MORE
              </div>
            </Button>
          </div>
      ...
      <div className="h-[1869px] relative w-full max-w-[1104px] mx-auto px-12 mt-[800px]">
        ...
        <Button className="absolute w-[184px] h-[53px] top-24 left-[920px] bg-[#ffffff01] rounded-[100px] overflow-hidden shadow-[0px_0px_0px_1px_#f8f8ff] h-auto">
